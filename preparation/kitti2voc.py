# -*- coding: utf-8 -*-
# @Time    : 2020/9/22 20:36
# @Author  : Zeqi@@
# @FileName: kitti2voc.py
# @Software: PyCharm
...
class kitti2voc:
    ...
    """
    def __init__(self, image_path_src , image_path_dst , kitti_anat_path , voc_anat_path, txt_file):
        """
            indicate the path
        """
    ...
    def convert_process(self):
        ...
        with tqdm(total=7481, desc=f'Transferring kitti files', postfix=dict, mininterval=0.3) as pbar:
            for filename in os.listdir(self.kitti_anat_path):
                ...
                pbar.set_postfix(**{'file_name': filename})
                pbar.update(1)
                # IND+=1
                # if IND >= 10:
                #     break
...
if __name__ =='__main__':
    ...
    image_path_src = "../../kitti2voc/kitti_obj/data_object_image_3/training/image_3/"
    image_path_dst = "../../../Kitti_project/kitti_voc/JPEGImages_right/"
    kitti_anat_path= "../../kitti2voc/kitti_obj/data_object_label_2/training/label_2/"
    voc_anat_path = "../../../Kitti_project/kitti_voc/Annotations/"
    os.makedirs(image_path_dst, exist_ok=True)
    os.makedirs(voc_anat_path, exist_ok=True)
    kitti2voc_ins = kitti2voc(image_path_src,image_path_dst,kitti_anat_path,voc_anat_path, txt_file='data_txt/kitti_trainval.txt')
